...
import { LoginAPI } from "../../../components/GlobalApi/Index";
...
const SignIn = () => {
  ...
  return (
    <div className=" w-full h-[100vh] flex items-center justify-center">
      <div className=" relative bg-gray-100 shadow-lg shadow-black lg:w-[30%] w-[80%] px-4 py-6 rounded-lg">
        <form onSubmit={handleSubmit(onSubmit)} action="">
          ...
          <button
            type="submit"
            className="flex items-center justify-center w-full px-8 h-[30px] max-h-[30px] mt-5 text-[14px] font-medium text-white transition-all duration-200 bg-[#4F46E5] border border-transparent hover:border-[#4F46E5] hover:!bg-white hover:text-[#4F46E5] rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray  hover:bg-grayDark"
          >
            {loader ? (
              <div role="status">
                <svg
